...
tests = do
    ...
    return $ testGroup "HW2.T1" [option, pair, quad, annotated, except, prioritised, list, fun, tree, propAnnotated, propExcept, propList, propOption, propPair, propPrioritised, propQuad, propTree]
